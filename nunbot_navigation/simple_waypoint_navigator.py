...
class SimpleWaypointNavigator(Node):
    def __init__(self):
        ...
        self.linear_speed = 0.18  # m/s
        self.rotation_speed = 0.18  # m/s
    ...
    def send_initial_pose(self):
        ...
        initial_pose_msg.pose.covariance = [0.001]*36
        ...
        if self.state == NavigationState.WAITING_FOR_START:
            ...
            if elapsed > 15.0:  # 15 seconds elapsed
                if self.amcl_initialized:
                    ...
                    self.get_logger().error('AMCL failed to initialize properly')
